      ...
      <div className="relative">
        <div className="mt-12 grid grid-cols-1 rounded-md lg:grid-cols-6 xl:border dark:border-neutral-800">
          {features.map((feature) => (
            <FeatureCard
              key={feature.title}
              className={`   relative  ${feature.className}`}
            >
              {feature.id % 2 == 0 && <ShineBorder shineColor="#ff6f00" />}
      ...
      <div className="group mx-auto h-full w-full bg-white p-5 shadow-2xl dark:bg-neutral-900">
        <div className="flex h-full w-full flex-1 flex-col space-y-2">
          ...
          <img
            ...
            width={500}
            height={500}
            className=" max-h-[300px] w-full rounded-sm object-cover object-left-top"
          />
        </div>
      </div>
    ...
    >
      <div className="group mx-auto h-full w-full bg-transparent dark:bg-transparent">
        <div className="relative flex h-full w-full flex-1 flex-col space-y-2">
          {/* TODO */}
          <img
            src="/life_easy_card1.svg"
            alt="header"
            width={800}
            height={800}
            className=" w-full max-h-[300px] rounded-sm object-cover object-center blur-none transition-all duration-200 group-hover/image:blur-md"
          />
        </div>
      </div>
    </a>
