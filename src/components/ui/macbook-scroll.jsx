...
export const MacbookScroll = ({ src, showGradient, title, badge }) => {
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[100vh] sm:min-h-[150vh] md:min-h-[320vh] shrink-0 transform flex-col items-center justify-start py-10 md:py-0 [perspective:800px] md:pb-80 md:pt-20 overflow-hidden w-full"
    >
      <motion.div
        style={{
      ...
      {/* MacBook wrapper — scales down on small screens */}
      <div className="w-full flex flex-col items-center scale-[0.45] xs:scale-[0.55] sm:scale-75 md:scale-100 origin-top transition-transform">
        {/* Lid */}
        <Lid
          src={src}
          scaleX={scaleX}
...
const AceternityLogo = () => {
  return (
    <Image
      width={500}
      height={500}
      className="w-[70px] h-[70px] [transform:perspective(900px)_rotateX(50deg)]"
      alt="s"
      src="/favicon.ico"
    ></Image>
  );
